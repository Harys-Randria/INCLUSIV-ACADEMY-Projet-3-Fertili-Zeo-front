              ...
              <div className="contact-one__form contact-one__form--contact">
                ...
                >
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                      <div className="input-box">
                        <label className="label-text" htmlFor="Adresse">
                          {" "}
                          Adresse
                        </label>
                        <input
                  ...
                  <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6">
                      <div className="input-box">
                        <label className="text-label" htmlFor="nifStat">
                          {" "}
                          Nif
                        </label>
                        <input
                          type="text"
                          name="nifStat"
                          placeholder="Nif_Stat"
                          value={this.state.nifStat || ""}
                          onChange={this.handleNifStatChange}
                          className={`form-control ${
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                      <div className="input-box">
                        <label className="text-label" htmlFor="cin">
                          {" "}
                          CIN
                        </label>
                        <input
