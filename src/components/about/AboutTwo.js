          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(" +
                publicUrl +
                "assets/images/backgrounds/about-v2-bg.png)",
            }}
          ></div>
              ...
              <div className="col-xl-6">
                <div className="about-two__img">
                  <div className="about-two__img1">
                    <img
                      src={publicUrl + "assets/images/about/about-v2-img1.jpg"}
                      alt="#"
                    />
                  </div>
                  <div
                  ...
                  >
                    <img
                      src={publicUrl + "assets/images/about/about-v2-img2.jpg"}
                      alt="#"
                    />
                  </div>
                ...
                <div className="about-two__content">
                  <div className="sec-title style2">
                    <div className="sec-title__tagline">
                      <div className="img-box">
                        <img
                          src={
                            publicUrl +
                            "assets/images/resources/sec-title-img2.png"
                          }
                          alt="#"
                        />
                      </div>
                    ...
                    <h2 className="sec-title__title">
                      We Provide Gardening <br /> Best Services
                    </h2>
                  </div>
