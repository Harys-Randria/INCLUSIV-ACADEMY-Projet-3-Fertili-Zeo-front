        ...
        <div className="container py-4">
            <div className="row">
                <div className="col-md-6">
                    <img src={activeImg} alt="" className="img-fluid rounded-xl" />
                    <div className="d-flex justify-content-between mt-3">
                        <img src={images.img1} alt="" className="img-thumbnail cursor-pointer" onClick={() => setActiveImage(images.img1)} />

                    </div>
                </div>
                <div className="col-md-6">
                    <div>
                        <span className="text-primary font-weight-bold">Special Sneaker</span>
                        <h1 className="text-3xl font-weight-bold">Nike Invincible 3</h1>
                    </div>
                    ...
                    <h6 className="text-xl font-weight-bold">$ 199.00</h6>
